    ...
    public void run() {
        do {
            try {
                ...
                System.out.println(MosquittoColor.BLUE_BRIGHT + "[MosquittoServer] [Server] [Reader]: " + MosquittoColor.WHITE_BRIGHT + "uma nova conexão foi aceita de: " + MosquittoColor.YELLOW_BRIGHT + client.getDisplayName() + MosquittoColor.RESET);
            } catch (SocketException ignored) {
            } catch (IOException e) {
                System.out.println(MosquittoColor.RED + "[MosquittoServer] [Server] [Reader]: " + MosquittoColor.RED_BRIGHT + "ocorreu um erro ao aceitar a conexão de um novo cliente!" + MosquittoColor.RESET);
            }
